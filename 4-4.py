...
data_transposed = pd.read_excel('Transposed_宇海数据.xlsx')
# data_transposed = pd.read_excel('Standardized_Expanded_Data.xlsx')
# data_transposed = pd.read_excel('Normalized_Expanded_Data.xlsx')
# 仅使用前 25/50/75/100/125 行数据
# data_transposed = data_transposed.head(125)

# Preparing the data
X = data_transposed[['上长S', '下长S', '左宽S', '右宽S']]
